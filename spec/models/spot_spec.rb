...
describe "Spot" do
  ...
  it "should initialize with latitude coordinate" do
    expect(@spot.latitude).to eq(40.705765)
  end

  it "should initialize with longitude coordinate" do
    expect(@spot.latitude).to eq(-74.007659)
  end
  ...
  describe "#get_street_sections" do
    ...
    it "should return street section with same mainstreet as spot" do
      # sections = created_spot.get_street_sections
      expect(spot.main_street.upcase).to eq(sections[0].main_street.upcase)
    end

    it "should return street section with same mainstreet as spot" do
      # sections = created_spot.get_street_sections
      expect(spot.main_street.upcase).to eq(sections[1].main_street.upcase)
    end
  end
  ...
  describe "#get_signs" do
    ...
    it 'should identify correct sign' do
